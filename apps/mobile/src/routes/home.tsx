...
function HomePage() {
  ...
  return (
    <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center gap-4">
      <div className="w-[390px] h-[844px] py-6 flex flex-col gap-4 bg-background">
        <div className="flex p-6 w-[390px] gap-12 h-[49px] items-center">
            <p className="text-primary text-lg w-[132px] h-[23px]">Dashboard</p>
            <div className="flex ml-auto items-center gap-[12px] w-[144px] h-[25px]">
              <Button className="w-[70px] h-[24px]">
                <p className="text-sm">Admin</p>
              </Button>
              <Button className="w-[25px] h-[25px] bg-background">
                <svg viewBox="0 0 25 25" style={{ width: '25px', height: '25px' }} fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_415_319)">
                <path d="M12.5 14.0625C16.3818 14.0625 19.5312 10.9131 19.5312 7.03125C19.5312 3.14941 16.3818 0 12.5 0C8.61816 0 5.46875 3.14941 5.46875 7.03125C5.46875 10.9131 8.61816 14.0625 12.5 14.0625ZM18.75 15.625H16.0596C14.9756 16.123 13.7695 16.4062 12.5 16.4062C11.2305 16.4062 10.0293 16.123 8.94043 15.625H6.25C2.79785 15.625 0 18.4229 0 21.875V22.6562C0 23.9502 1.0498 25 2.34375 25H22.6562C23.9502 25 25 23.9502 25 22.6562V21.875C25 18.4229 22.2021 15.625 18.75 15.625Z" fill="#404040"/>
                </g>
                <defs>
        ...
        <div className="fixed flex justify-evenly w-[342px] h-[58px] p-[32px] py-[17px] top-[769px] left-[24px] rounded-[15px] bg-muted items-center">
          <Button className="w-[25px] h-[25px] bg-muted ">
            <svg viewBox="0 0 25 20" fill="none" style={{ width: '25px', height: '25px' }} xmlns="http://www.w3.org/2000/svg">
          ...
          <Button className="w-[25px] h-[25px] bg-muted">
            <svg viewBox="0 0 25 25" style={{ width: '25px', height: '25px' }} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.3125 2.34375C20.3125 1.91211 19.9629 1.5625 19.5312 1.5625H16.4062C15.9746 1.5625 15.625 1.91211 15.625 2.34375V4.6875H20.3125V2.34375ZM3.12061 7.81201C2.99805 12.3945 0.168945 13.3896 0 19.7266V21.875C0 22.7378 0.699707 23.4375 1.5625 23.4375H6.25C7.11279 23.4375 7.8125 22.7378 7.8125 21.875V14.0625H9.375V6.25H4.67969C3.81885 6.25 3.14404 6.95166 3.12061 7.81201ZM21.8794 7.81201C21.856 6.95166 21.1812 6.25 20.3203 6.25H15.625V14.0625H17.1875V21.875C17.1875 22.7378 17.8872 23.4375 18.75 23.4375H23.4375C24.3003 23.4375 25 22.7378 25 21.875V19.7266C24.8311 13.3896 22.002 12.3945 21.8794 7.81201ZM8.59375 1.5625H5.46875C5.03711 1.5625 4.6875 1.91211 4.6875 2.34375V4.6875H9.375V2.34375C9.375 1.91211 9.02539 1.5625 8.59375 1.5625ZM10.9375 14.0625H14.0625V6.25H10.9375V14.0625Z" fill="#404040"/>
            </svg>
          </Button>
        </div>
        <div className="flex flex-col p-4 w-[390px] h-[769px] gap-4">
          <div className="flex justify-evenly items-center w-[365px] h-[302px] p-[1px]">
            <div className="flex flex-col w-[126px] h-[302px] pl-[10px] pt-[15px] pr-[22px] pb-[7px] gap-[10px]">
              <div className="flex flex-col bg-muted w-[94px] h-[86.67px] gap-[10px] p-[10px] py-[11px] algin-center rounded-[15px]">
                <p className="text-[32px]">846</p>
                <p className="text-[12px] text-primary">shifts done</p>
              </div>
              <div className="flex flex-col bg-muted w-[94px] h-[86.67px] gap-[10px] p-[10px] py-[11px] algin-center rounded-[15px]">
                <p className="text-[32px]">254</p>
                <p className="text-[12px] text-primary">shifts left</p>
              </div>
              <div className="flex flex-col bg-muted w-[94px] h-[86.67px] gap-[10px] p-[10px] py-[11px] algin-center rounded-[15px]">
                <p className="text-[32px]">10</p>
                <p className="text-[12px] text-primary">till break</p>
              </div>
            </div>
            <div className="flex items-center justify-center flex-col w-[237px] h-[282px] gap-[10px] pl-[18px] pt-[10px] pr-[18px] rounded-[15px] bg-muted">
              <p className="text-border text-center text-[15px]">No matches assigned...</p>
            </div>
          </div>
          <div className="flex flex-col w-[358px] h-[196px] gap-[16px]">
            <div className="flex w-[358px] h-[20px] gap-[10px]">
              <p className="text-[16px] text-primary">Scouting</p>
            </div>
            <div className="flex justify-evenly w-[358px] h-[160px] gap-[16px]">
              <div className="flex flex-col bg-muted rounded-[15px] w-[171px] h-[160px] gap-20 p-6">
                <p className="text-primary text-[16px]">Pit Scouting</p>
                <div className="flex w-full items-center h-full gap-15">
                  <p className="text-[15px]">Start</p>
                  <Button className="w-[30px] h-[30px] bg-background">
                    <svg viewBox="0 0 30 30" fill="none" style={{ width: '30px', height: '30px' }} xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_418_367)">
                    <path d="M15 0.46875C23.0273 0.46875 29.5312 6.97266 29.5312 15C29.5312 23.0273 23.0273 29.5312 15 29.5312C6.97266 29.5312 0.46875 23.0273 0.46875 15C0.46875 6.97266 6.97266 0.46875 15 0.46875ZM13.3066 8.88281L17.7305 13.125H7.03125C6.25195 13.125 5.625 13.752 5.625 14.5312V15.4688C5.625 16.248 6.25195 16.875 7.03125 16.875H17.7305L13.3066 21.1172C12.7383 21.6621 12.7266 22.5703 13.2832 23.127L13.9277 23.7656C14.4785 24.3164 15.3691 24.3164 15.9141 23.7656L23.6895 15.9961C24.2402 15.4453 24.2402 14.5547 23.6895 14.0098L15.9141 6.22852C15.3633 5.67773 14.4727 5.67773 13.9277 6.22852L13.2832 6.86719C12.7266 7.42969 12.7383 8.33789 13.3066 8.88281Z" fill="#FBBF24"/>
                    </g>
                    <defs>
              ...
              <div className="flex flex-col bg-muted rounded-[15px] w-[171px] h-[160px] gap-20 p-6">
                <p className="text-primary text-[16px]">Match Scouting</p>
                <div className="flex w-full items-center h-full gap-15">
                  <p className="text-[15px]">Start</p>
                  <Button className="w-[30px] h-[30px] bg-background">
                    <svg viewBox="0 0 30 30" fill="none" style={{ width: '30px', height: '30px' }} xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col w-[358px] h-[196px] gap-[16px]">
            <div className="flex w-[358px] h-[20px] gap-[10px]">
              <p className="text-[16px] text-primary">Picklist</p>
            </div>
            <div className="flex justify-evenly w-[358px] h-[160px] gap-[16px]">
              <div className="flex flex-col bg-muted rounded-[15px] w-[171px] h-[160px] gap-20 p-6">
                <p className="text-primary text-[16px]">New Picklist</p>
                <div className="flex w-full items-center h-full gap-15">
                  <p className="text-[15px]">Start</p>
                  <Button className="w-[30px] h-[30px] bg-background">
                    <svg viewBox="0 0 30 30" fill="none" style={{ width: '30px', height: '30px' }} xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex flex-col bg-muted rounded-[15px] w-[171px] h-[160px] gap-20 p-6">
                <p className="text-primary text-[16px] w-[170px]">View Last Picklist</p>
                <div className="flex w-full items-center h-full gap-15">
                  <p className="text-[15px]">Start</p>
                  <Button className="w-[30px] h-[30px] bg-background">
                    <svg viewBox="0 0 30 30" fill="none" style={{ width: '30px', height: '30px' }} xmlns="http://www.w3.org/2000/svg">
