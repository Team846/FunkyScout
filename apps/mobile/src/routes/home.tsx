      ...
      <nav className="fixed inset-x-0 bottom-0 z-50">
        <div className="mx-auto w-full max-w-md px-4 pb-[calc(env(safe-area-inset-bottom,0px)+12px)]">
          <div className="flex items-center justify-between rounded-2xl bg-muted px-6 py-4 shadow-lg">
            <Button
              className="h-10 w-10 bg-muted p-0"
            ...
            >
              ...
              >
                <path
                  ...
                  fill={currentPage === "dashboard" ? "#FBBF24" : "#404040"}
                />
              </svg>
            </Button>
            ...
            >
              ...
              >
                <path
                  ...
                  fill={currentPage === "shifts" ? "#FBBF24" : "#404040"}
                />
              </svg>
            </Button>
              ...
              >
                <g clipPath="url(#clip0_415_340)">
                  <path
                    ...
                    fill={currentPage === "data" ? "#FBBF24" : "#404040"}
                  />
                </g>
                <defs>
            ...
            >
              ...
              >
                <path
                  ...
                  fill={currentPage === "scouting" ? "#FBBF24" : "#404040"}
                />
              </svg>
            </Button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto py-2">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-row gap-3 p-2">
                <Button
                  variant="ghost"
                  className="flex-1  border border-chart-2/60"
                  onClick={() => {
